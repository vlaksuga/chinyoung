...
class M_test extends CI_Model{
	...
	{
		$sql="select *,(select GROUP_CONCAT(DISTINCT effect ORDER BY collectionid SEPARATOR ',') effect from tile where collectionid = collection.collectionid) effect from collection limit ?,?";
